...
export {
  ...
  getApiKeyBySecret, addKeySpend, budgetPeriodMs, reserveApiKeyTokens, settleApiKeyTokens,
  ...
  db.transaction(() => {
    ...
    for (const c of payload.combos || []) {
      db.run(
        ...
        [c.id, c.name, c.kind || null, stringifyJson(c.models || []), c.config ? stringifyJson(c.config) : null, c.createdAt || new Date().toISOString(), c.updatedAt || new Date().toISOString()]
      );
    }
