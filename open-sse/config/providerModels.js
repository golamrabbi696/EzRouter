...
import { CODEX_REVIEW_SUFFIX, isMuseSparkModel, isOpencodeResponsesModel } from "../providers/models/helpers.js";
...
export function getModelTargetFormat(aliasOrId, modelId) {
  if ((!aliasOrId || aliasOrId === "oc" || aliasOrId === "opencode" || aliasOrId === "ocg" || aliasOrId === "opencode-go") && isOpencodeResponsesModel(modelId)) {
