...
export function saveUsageStats({ provider, model, tokens, connectionId, apiKey, endpoint, requestedModel, status, pricingMultiplier = 1, label = "USAGE", silent = false }) {
  ...
  if (pricingMultiplier !== 1) normalized.pricing_multiplier = pricingMultiplier;
