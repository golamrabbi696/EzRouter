export default {
  ...
  models: [
    ...
    { id: "veo-3.1-generate-001", name: "Veo 3.1", params: ["duration","aspect_ratio","resolution","negative_prompt","seed","storage_uri","generate_audio"], kind: "video" },
    { id: "veo-3.1-fast-generate-001", name: "Veo 3.1 Fast", params: ["duration","aspect_ratio","resolution","negative_prompt","seed","storage_uri","generate_audio"], kind: "video" },
    ...
    { id: "veo-3.0-fast-generate-001", name: "Veo 3 Fast", params: ["duration","aspect_ratio","resolution","negative_prompt","seed","storage_uri","generate_audio"], kind: "video" },
